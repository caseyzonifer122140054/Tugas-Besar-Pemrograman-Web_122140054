...
import { Calendar, Globe, Lock, ChevronLeft, MapPin } from "lucide-react"
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-2 text-travelmate-charcoal">
          Buat Perjalanan Baru
        </h1>
        <p className="text-muted-foreground mb-8">
          Isi detail informasi dibawah ini
        </p>
              ...
              >
                ...
                <div className="flex items-center space-x-3 border rounded-lg p-4 cursor-pointer hover:bg-muted/30">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Hanya kamu dan yg di invite yang bisa lihat
                    </p>
                  </div>
                </div>
              </RadioGroup>
