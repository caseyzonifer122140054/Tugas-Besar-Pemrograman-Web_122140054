...
const features = [
  {
    ...
    description:
      "Rencanakan perjalanan bersama teman dan keluarga secara real-time."
  },
  {
    icon: <Calendar className="h-8 w-8 text-travelmate-blue" />,
    title: "Itinerari Interaktif",
    description:
      "Buat dan atur aktivitas harian dengan antarmuka drag-and-drop kami."
  },
  {
    icon: <PieChart className="h-8 w-8 text-travelmate-blue" />,
    title: "Pelacakan Anggaran",
    description:
      "Pantau pengeluaran dan bagi biaya di antara peserta perjalanan."
  },
  {
    icon: <CheckSquare className="h-8 w-8 text-travelmate-blue" />,
    title: "Daftar Periksa Pintar",
    description:
      "Jangan pernah lupa barang penting dengan daftar packing yang dapat disesuaikan."
  },
  {
    icon: <Map className="h-8 w-8 text-travelmate-blue" />,
    title: "Integrasi Peta",
    description:
      "Visualisasikan tujuan Anda dan rencanakan rute secara efisien."
  }
]
        ...
        <div className="container mx-auto pb-16 overflow-hidden">
          ...
          <section className="py-20 px-6 relative min-h-[80vh] flex items-center">
            ...
            <div className="absolute inset-0 overflow-hidden -z-10">
              <Parallax
                translateY={["-10%", "10%"]}
                className="absolute top-20 right-10 w-64 h-64 rounded-full bg-travelmate-blue/10 blur-3xl"
              ></Parallax>
              <Parallax
                translateY={["5%", "-5%"]}
                className="absolute bottom-20 left-10 w-80 h-80 rounded-full bg-travelmate-purple/10 blur-3xl"
              ></Parallax>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                Perencanaan Perjalanan Jadi{" "}
                <span className="text-travelmate-blue">Mudah</span>
              </motion.h1>
              ...
              >
                Rencanakan perjalanan Anda secara kolaboratif bersama teman dan
                keluarga. Buat itinerari, lacak pengeluaran, dan ciptakan
                kenangan bersama.
              </motion.p>
          ...
          <section className="py-16 px-4 bg-gray-50 rounded-xl relative overflow-hidden">
            ...
            <Parallax
              translateY={["-5%", "5%"]}
              className="absolute top-0 right-0 w-96 h-96 rounded-full bg-travelmate-blue/5 blur-3xl -z-10"
            ></Parallax>
            <Parallax
              translateY={["10%", "-10%"]}
              className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-travelmate-purple/5 blur-3xl -z-10"
            ></Parallax>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <span className="text-travelmate-blue">
                  perjalanan sempurna
                </span>
              </motion.h2>
          ...
          <section className="py-20 px-4 text-center relative">
            ...
            >
              ...
              >
                Bergabunglah dengan TravelMate hari ini dan jadikan pengalaman
                perencanaan perjalanan Anda bebas stres dan menyenangkan.
              </motion.p>
